...
namespace HermesProxy
{
    public class AuthClient
    {
        ...
        public AuthResult ConnectToAuthServer()
        {
            ...
            while (_authResult == null)
            { }

            return (AuthResult)_authResult;
        }
        ...
        private void HandleRealmList(ByteBuffer packet)
        {
            ...
            for (ushort i = 0; i < realmsCount; i++)
            {
                ...
                realmInfo.Flags = (Framework.Constants.RealmFlags)packet.ReadUInt8();
                ...
                if ((realmInfo.Flags & Framework.Constants.RealmFlags.SpecifyBuild) != 0)
                {
